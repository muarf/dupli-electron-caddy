...
function seed_tirage_schema(PDO $pdo): void
{
    ...
    $pdo->exec('CREATE TABLE IF NOT EXISTS photocop (id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT, marque TEXT, contact TEXT, nb_f INTEGER, rv TEXT, prix REAL, paye TEXT, cb TEXT, mot TEXT, date INTEGER, tirage_global_id TEXT, session_id TEXT, document_name TEXT, thumbnail_url TEXT, nb_exemplaires INTEGER DEFAULT 1, taille TEXT DEFAULT \'\')');
