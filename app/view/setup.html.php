...
<head>
    ...
    <title><?php _e("auto_clean.setup_html_php_1", [], false); ?></title>
    ...
    <div class="setup-container">
        ...
        <?php if ($mode === 'create'): // Script uniquement pour le mode create ?>
            <script>
                const CONFIG = {
                    translations: {
                        configure: <?= json_encode(__('setup.configure')) ?>,
                        already_configured: <?= json_encode(__('setup.already_configured')) ?>,
                        reconfigure: <?= json_encode(__('setup.reconfigure')) ?>,
                        manual: <?= json_encode(__('setup.manual')) ?>,
                        duplicator_config_title: <?= json_encode(__('setup.duplicator_config_title')) ?>,
                        photocopier_ink_config_title: <?= json_encode(__('setup.photocopier_ink_config_title')) ?>,
                        photocopier_toner_config_title: <?= json_encode(__('setup.photocopier_toner_config_title')) ?>,
                        machine_name: <?= json_encode(__('setup.machine_name')) ?>,
                        passage_counter: <?= json_encode(__('setup.passage_counter')) ?>,
                        missing_fields: <?= json_encode(__('setup.missing_fields')) ?>,
                        missing_fields_msg: <?= json_encode(__('setup.missing_fields_msg')) ?>,
                        missing_master_msg: <?= json_encode(__('setup.missing_master_msg')) ?>,
                        duplicator: <?= json_encode(__('setup.duplicator')) ?>,
                        photocopier_ink: <?= json_encode(__('setup.photocopier_ink')) ?>,
                        photocopier_toner: <?= json_encode(__('setup.photocopier_toner')) ?>,
                        remove: <?= json_encode(__('setup.remove')) ?>,
                        no_machine_title: <?= json_encode(__('setup.no_machine_title')) ?>,
                        no_machine_msg: <?= json_encode(__('setup.no_machine_msg')) ?>,
                        drum_name: <?= json_encode(__('setup.drum_name')) ?>,
                        drum_name_placeholder: <?= json_encode(__('setup.drum_name_placeholder')) ?>,
                        unit_price: <?= json_encode(__('setup.unit_price')) ?>,
                        pack_price: <?= json_encode(__('setup.pack_price')) ?>
                    }
                };
            </script>
            <script src="<?= $base_path ?? '' ?>js/setup.js" defer></script>
        <?php endif; ?>
